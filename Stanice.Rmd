...
choices.id <- unique(as.character(poloha$Oznaceni))

mojePaleta <- c("#e6b800", "#009999", "#003366", "#000033")
  ...
  mapa <- leaflet() %>% addTiles() %>% 
    ...
    addCircleMarkers(data = poloha_r, lng = poloha_r$coords.x1, lat = poloha_r$coords.x2,
     ...
     addCircleMarkers(data = poloha_b, lng = poloha_b$coords.x1, lat = poloha_b$coords.x2, 
                                             ...
                                             fillOpacity = 1, layerId = poloha_b$Oznaceni, popup = label.points_b, clusterOptions=markerClusterOptions())
  print(mapa)
